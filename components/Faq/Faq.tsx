...
export default function Faq() {
    ...
    const iconArrow = () => { return <Image src={ARROW} alt='arrow' width={30} height={30}/>}
    const iconPlus = () => { return <Image src={PLUS} alt='arrow' width={30} height={30}/>}
    ...
    const faqs = [
        ...
        { question: '¿Cómo puedo participar en los testeos de ViajAR App?', answer: 'Estamos reclutando testers para probar la aplicación y proporcionarnos comentarios valiosos. Si estás interesado en ser parte de nuestros testers, por favor registráte en nuestro sitio web y te vamos a mantener informado sobre cómo participar.' },
        ...
        { question: '¿Cómo puedo contactar al equipo de ViajAR App si tengo más preguntas?', answer: 'Si tienes más preguntas o necesitas ayuda, no dudes en contactarnos a través de nuestro correo electrónico de\nsoporte: admin@viajarapp.com o a través de nuestras redes sociales <Link href="https://www.instagram.com/viajar_app/">Instagram</Link>' },
